...
public class MensagensTest extends UsuarioESenha {
    ...
    public void DeveriaEfetuarLogin() throws InterruptedException {
        ...
        driver.findElement(By.id("txtLogin")).sendKeys(getUser());
        driver.findElement(By.id("txtPassword")).sendKeys(getPassword());
